  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-6 left-6 z-50 p-3 bg-background border border-border rounded-lg shadow-sm hover:shadow-md transition-all duration-200"
      >
      ...
      {/* Navigation */}
      <nav className={`
        fixed left-0 top-0 h-full w-60 bg-background border-r border-border flex flex-col z-40 transition-transform duration-300
