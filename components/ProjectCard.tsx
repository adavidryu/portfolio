...
export default function ProjectCard({
  ...
  return (
    <article className="flex h-full flex-col border-t border-border pt-5">
      ...
      {award && (
        <p className="mb-3 inline-flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.1em] text-amber-700">
          <svg className="h-3.5 w-3.5 shrink-0 fill-amber-500" viewBox="0 0 20 20" aria-hidden="true">
